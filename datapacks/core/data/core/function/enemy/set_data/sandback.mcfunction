data merge entity @s {NoAI:1b,Tags:["enemy","enemy.normal","enemy.1"],equipment:{saddle:{id:"saddle",components:{enchantments:{"core:direct_attack":1}}},mainhand:{"id":"stick"}},drop_chances:{saddle:0,mainhand:0},Glowing:true,active_effects:[{duration:-1,show_icon:0b,amplifier:4b,id:"minecraft:resistance",show_particles:0b}],Team:"enemy"}
...
$execute store result score @s Core.Status.Health run data get storage enemy:hp Normal[$(level)] 1
