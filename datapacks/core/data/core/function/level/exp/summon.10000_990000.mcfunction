summon item ~ ~ ~ {Item:{id:"lime_glazed_terracotta",count:1,components:{"item_name":"exp:10000~990000",custom_data:{exp:10000},max_stack_size:99}},Age:5100,Tags:["exp.orb","exp.nowdrop"]}
