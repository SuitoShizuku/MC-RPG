...
summon item ~ ~ ~ {Item:{id:"lime_glazed_terracotta",count:1,components:{"item_name":"exp:100~9900",custom_data:{exp:100},max_stack_size:99}},Age:5100,Tags:["exp.orb","exp.nowdrop"]}
