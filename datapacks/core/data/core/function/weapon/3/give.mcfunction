...
give @s paper[\
    ...
    max_stack_size=1,\
    attribute_modifiers=[{amount:-99,id:"minecraft:base_attack_damage",operation:"add_value",slot:"mainhand",type:"attack_damage"},{amount:-2.4,id:"minecraft:base_attack_speed",operation:"add_value",slot:"mainhand",type:"attack_speed"},{amount:-99,id:"base_attack_reach",operation:"add_value",slot:"mainhand",type:"entity_interaction_range"}],\
    ...
    enchantments={"core:bullet/weapon.1":1},\
