...
execute positioned ~-3 ~ ~-2 run scoreboard players set @a[dx=5,dy=0,dz=3] Core.Weapon.Custom.3.skill.time 4
execute positioned ~-2 ~ ~-2 run scoreboard players set @a[dx=5,dy=0,dz=3] Core.Weapon.Custom.3.skill.time 4