particle dust_color_transition{from_color:[0.8,0.2,0.1],to_color:[1.0,0.3,0.1],scale:0.6} ^ ^ ^ 0.15 0.15 0.15 0 2 normal @a
particle dust_color_transition{from_color:[0.8,0.2,0.1],to_color:[1.0,0.3,0.1],scale:0.6} ^ ^ ^0.35 0.15 0.15 0.15 0 2 normal @a
tp @s ^ ^ ^0.7
