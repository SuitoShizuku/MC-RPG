...
execute as @n[tag=damage.attacker] if items entity @s weapon.mainhand *[minecraft:custom_data~{core:{id:"2"}}] if score @s Core.Detect.FullCharge matches 1..2 at @s anchored eyes rotated ~ 0 positioned ^ ^-0.6 ^1.4 run function core:weapon/2/passive
