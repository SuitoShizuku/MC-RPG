...
scoreboard players remove @s Core.Detect.FullCharge 30
execute if score @s Core.Detect.FullCharge matches ..0 run scoreboard players set @s Core.Detect.FullCharge 1
