...
execute if score @s Core.Detect.FullCharge matches 151..153 run return run scoreboard players set @s Core.Detect.FullCharge 1
execute if score @s Core.Detect.FullCharge matches 101..103 run return run scoreboard players set @s Core.Detect.FullCharge 2
