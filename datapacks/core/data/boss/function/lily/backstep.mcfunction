execute facing entity @p feet positioned 0.0 0.0 0.0 positioned ^ ^ ^-1.0 positioned ~ 0.5 ~ run summon marker ~ ~ ~ {Tags:["marker","enemy.boss.lily.marker","enemy.boss.lily.backstep"]}
